...
// API URLs
// ---------------------------------------------------------------------------
export const observabilityLogsApiUrl = 'https://localhost:6448/icp/observability/logs?live=true';
export const observabilityMetricsApiUrl = 'https://localhost:6448/icp/observability/metrics';
