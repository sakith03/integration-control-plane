    ...
    <Box sx={{ height: '100vh', display: 'flex' }}>
      <Grid container sx={{ flex: 1 }}>
        <Grid
          ...
          <Box>
            <Stack direction="column" alignItems="start" gap={2} maxWidth={580} display={{ xs: 'none', md: 'flex' }}>
              <Box sx={{ my: 3 }}>
                <ColorSchemeImage
                  src={{
                    light: `${base}assets/images/${content.logo}.svg`,
                    dark: `${base}assets/images/${content.logo === 'logo' ? 'logo-inverted' : content.logo}.svg`,
                  }}
                  alt={{
                    light: `${content.logoAlt} (Light)`,
                    dark: `${content.logoAlt} (Dark)`,
                  }}
          ...
          <ColorSchemeImage
            src={{
              light: `${base}assets/images/${content.bg}.svg`,
              dark: `${base}assets/images/${content.bg.replace('login', 'login-inverted')}.svg`,
            }}
