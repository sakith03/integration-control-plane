  ...
  return (
    <Stack gap={1}>
      {expandedItems.map((item, i) => (
        <Box key={i} sx={{ bgcolor: 'action.hover', p: 1.5, borderRadius: 1, display: 'flex', alignItems: 'center', gap: 1.5, border: '1px solid', borderColor: 'divider' }}>
    ...
    <Stack gap={1}>
      {resources.length === 0 ? (
        ...
        resources.map((r, i) => {
          ...
          return (
            <Box key={i} sx={{ bgcolor: 'action.hover', p: 1.5, borderRadius: 1, display: 'flex', alignItems: 'center', gap: 1.5, flexWrap: 'wrap', border: '1px solid', borderColor: 'divider' }}>
